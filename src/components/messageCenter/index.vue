        ...
        <div class="flex-center">
            <div class="mainList">
                <div class="messageCenter-menu-card">
                    <div class="messageCenter-card-info flex-center" v-for="(item,index) in selects" :key="index">
                        <div    @click="selectTab(item.key)" :class="chooseTab===item.key ? item.active:item.class">
                            <h1><span>10</span></h1>
                ...
                <div class="messageCenter-main">
                    <div class="messageCenter-main-left">
                        <div class="message-tab">
                            <div>
                            <span class="defaultTab"
                                  v-for="(item,index) in tabs"
                                  :key="index"
                                  :class="chooseItem===item.id?'activeTab':''"
...
<script>
    export default {
        ...
        data(){
          return{
             selects:[
                 {key:1,title:'通知消息',class:'card-1',active:'activeCard-1'},
                 {key:2,title:'报备消息',class:'card-2',active:'activeCard-2'},
                 {key:3,title:'审批',class:'card-3',active:'activeCard-3'},
                 {key:4,title:'评论',class:'card-4',active:'activeCard-4'},
                 {key:5,title:'公告',class:'card-5',active:'activeCard-5'},
             ],
              tabs:[
                  {id:1,title:'全部消息'},
                  {id:2,title:'已读'},
