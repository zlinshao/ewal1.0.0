    ...
    <div class="kpiTable">
      <div class="table">
        ...
        <el-table :data="seasonData" v-if="choosedPeriod===2" highlight-current-row header-row-class-name="tableHeader">
          <el-table-column label="姓名" prop="name" align="center"></el-table-column>
          <el-table-column label="部门" prop="department" align="center"></el-table-column>
          <el-table-column label="第一季度" prop="first" align="center"></el-table-column>
          <el-table-column label="第二季度" prop="second" align="center"></el-table-column>
          <el-table-column label="第三季度" prop="third" align="center"></el-table-column>
          <el-table-column label="第四季度" prop="forth" align="center"></el-table-column>
        </el-table>
        ...
        if (res.status === 200) {
          ...
          for (let i = 0; i < res.data.length; i++) {
            let obj = {
              ...
              department: res.data[i].org_info,
            };
