        ...
        <div class="dialog_container">
          <div class="dialog_header">
            ...
            <div class="header_right" v-if="is_control === 'look'">
              <div v-if="dblCurrentRow.status!=1 && $storage.get('VALIDATE_PERMISSION')['Recruit-Position-Edit']" class="btn_edit" @click="is_control = 'edit'"></div>
            </div>
          </div>
          ...
          <div class="dialog_footer" v-if="is_control === 'look'">
            <el-button si ze="small" type="danger" @click="stop_need_visible = true" v-if="dblCurrentRow.status === 0 && $storage.get('VALIDATE_PERMISSION')['Recruit-Position-Finish']">
              结束招聘该岗位
            </el-button>
