<template>
  <div id="discussPolitics" class="discuss-politics">
            ...
            <div class="eltimeline-container">
              <el-timeline>
                <el-timeline-item :key="index" :color="item.todoType==0?'#50E38F':item.todoType==1?'#FFAE00':'#FF7A3C'"
                                  v-if="item.todoListTimeLine&&item.todoListTimeLine.length>0"
                  ...
                  <div :class="{prev:item.type=='prev'}" class="timeline-item-container">
                    <div :class="{'cancel-status':contentItem.status==2||contentItem.status==1}"
                         class="timeline-item-container-content-item"
                         @click="openMeetingDialog(contentItem)" :title="contentItem.content"
      ...
      <div class="dialog_container scroll_bar meeting-detail-container-outer">
        ...
        <div class="meeting-detail-container" style="margin: 20px 0 0 0">
          ...
          <div v-if="meeting_detail_choose_id==2" class="meeting-detail-form-container">
            ...
            <el-form ref="remainingFormRef" :model="meeting_remaining_form" style="text-align: left"
    ...
    <!--会议个数详情dialog  -->
    <lj-dialog :visible="meeting_counts_dialog_visible" :size="{width: 800 + 'px',height: 600 + 'px'}"
        ...
        <div class="dialog_main borderNone add-meeting-container">
          <el-form ref="addMeetingForm" :rules="rules.addMeeting" :model="add_meeting_form" style="text-align: left"
            ...
            <el-form-item required prop="room_id" label="会议室">
              <dropdown-list ref="dropdown1" title="必选" :url="`${this.url}meeting/category`" code="1"
            ...
            <el-form-item required prop="meeting_type" label="会议类型">
              <dropdown-list ref="dropdown2" title="必选" :url="`${this.url}meeting/category`" code="2"
            ...
            <el-form-item label="会议时间">
              <date-time-picker :clearable="false" ref="meetingTime" :width="320"
                                date-type="timerange"></date-time-picker>
            </el-form-item>
    ...
    <!--添加会议室-->
    <lj-dialog :visible="add_meeting_room_dialog_visible" :size="{width: 500 + 'px',height: 300 + 'px'}"
      ...
      <div class="dialog_container">
        ...
        <div class="dialog_main borderNone add-meeting-room-container">
          <el-form ref="addMeetingRoomForm" :rules="rules.addMeetingRoom" :model="add_meeting_room_form"
    ...
    <!--查看会议室dialog-->
    <lj-dialog :visible="view_meeting_room_dialog_visible" :size="{width: 500 + 'px',height: 700 + 'px'}"
    ...
    <!--添加会议类型-->
    <lj-dialog :visible="add_meeting_type_dialog_visible" :size="{width: 500 + 'px',height: 300 + 'px'}"
      ...
      <div class="dialog_container">
        ...
        <div class="dialog_main borderNone add-meeting-type-container">
          <el-form ref="addMeetingTypeForm" :rules="rules.addMeetingType" :model="add_meeting_type_form"
                   style="text-align: left"
                   size="small" label-width="100px">
    ...
    <!--查看会议类型dialog-->
    <lj-dialog :visible="view_meeting_type_dialog_visible" :size="{width: 500 + 'px',height: 700 + 'px'}"
