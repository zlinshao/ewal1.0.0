                    ...
                    <div class="detail-left-list">
                        <div class="detail-box" v-for="(item,index) in detailDataList">
                            ...
                            <div class="detail-box-bottom">
                                <div class="bottom-left"><img src="../../../assets/image/newMedia/theme1/avatar.png" alt=""></div>
                                <div class="bottom-right">
                                    <p><span class="mar-right">{{item.name}}</span></p>
                                    <p><span class="mar-right">{{item.department}}</span><span>{{item.time}}</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="middle-info">
                        ...
                        <div class="detail-box-bottom">
                            ...
                            <div class="bottom-right">
                                ...
                                <p><span class="mar-right">{{detailData.department}}</span><span>{{detailData.time}}</span></p>
                            </div>
                        </div>
                ...
                <div class="detail-content-right flex-center">
                    <div class="right-info-icons">
                        ...
                        <div class="icon-list share-navbar">
                            <span class="share-navbar-box flex-center justify-around" v-if="share_navbar_visible">
                                <i class="sina-icon"></i>
                                <i class="wechat-icon"></i>
                                <i class="link-icon"></i>
                            </span>
                            <i class="icon-bg share-icon" @mouseenter="share_navbar_visible = true" @mouseleave="share_navbar_visible = false"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        data(){
            return{
                ...
                detailData:{
                    ...
                    content:'小编认为，其实我们每个人都有一个大侠梦，英雄梦！自打小，或幻想着成为一代武林宗师，惩奸除恶；或幻想着自己行走于市井之间，救死扶伤。长大后，经历过现实的洗礼磨练，发现自己怎么可能成为一代大侠？这辈子看来是实现不了了...... 不！小编要告诉你！大侠不仅仅存在在武侠小说里，其实在咱们乐伽就有一位大侠！小编认为，其实我们每个人都有一个大侠梦，英雄梦！自打小，或幻想着成为一代武林宗师，惩奸除恶；或幻想着自己行走于市井之间，救死扶伤。长大后，经历过现实的洗礼磨练，发现自己怎么可能成为一代大侠？这辈子看来是实现不了了...... 不！小编要告诉你！大侠不仅仅存在在武侠小说里，其实在咱们乐伽就有一位大侠！'
                },
                detailDataList:[
                    {
...
<style lang="scss" scoped>
    @import "../../../assets/scss/newMedia/components/hotNewsDetail.scss";
    @mixin hotImg($n, $m) {
            ...
            .detail-main{
                ...
                .detail-content{
                    ...
                    .detail-content-right{
                        ...
                        .share-navbar-box{
                            .sina-icon{
                                @include hotImg('theme1','weibo_0.png')
                            }
                            .wechat-icon{
                                @include hotImg('theme1','weixin_0.png')
                            }
                            .link-icon{
                                @include hotImg('theme1','lianjie_0.png')
                            }
                        }
                    }
                }
