<template>
  <div id="club">
    ...
    <!--确认结束-->
    <lj-dialog :visible="end_visible" :size="{width: 500 + 'px',height: 250 + 'px'}" @close="end_visible = false">
    ...
    <!--新增-->
    <lj-dialog :visible="add_visible" :size="{width: 1200 + 'px' ,height: 800 + 'px'}" @close="add_visible = false">
      <div class="dialog_container">
        <div class="dialog_header">
          <h3>新增活动</h3>
        </div>
        <div class="dialog_main borderNone">
          <el-form label-width="80px">
            ...
            <el-form-item label="活动时间">
              <el-date-picker v-model="showData.actionTime" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss"
