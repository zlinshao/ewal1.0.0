<template>
  <div id="new-village">
    <lj-dialog :visible="new_village_visible" :size="{width: 1200 + 'px',height: 850 + 'px'}" @close="handleCloseAddVillage">
                ...
                <el-col :span="6">
                  <el-form-item label="省">
                    <el-select v-model="new_village_form.province" placeholder="请选择" @change="handleChangeProvince">
                      <el-option v-for="item in province_list" :key="item.id" :value="item.province_id" :label="item.province_name"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item label="市">
                    <el-select v-model="new_village_form.city" placeholder="请选择" @change="handleChangeCity">
                      <el-option v-for="item in city_list" :key="item.city_name" :value="item.city_id" :label="item.city_name"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item label="区/县">
                    <el-select v-model="new_village_form.area" placeholder="请选择" @change="handleChangeArea">
                      <el-option v-for="item in area_list" :key="item.area_name" :value="item.area_id" :label="item.area_name"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item label="街道">
                    <el-select v-model="new_village_form.region" placeholder="请选择">
                      <el-option v-for="item in region_list" :key="item.region_name" :value="item.region_id" :label="item.region_name"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="6">
                  <el-form-item label="建筑年代">
                    <el-date-picker value-format="yyyy" placeholder="请输入" v-model="new_village_form.built_year"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                ...
                <el-col :span="6">
                  <el-form-item label="房屋类型">
                    <el-select placeholder="请输入" v-model="new_village_form.property_type">
                      <el-option v-for="(item,idx) in house_type_list" :key="idx" :value="item.id" :label="item.val"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
