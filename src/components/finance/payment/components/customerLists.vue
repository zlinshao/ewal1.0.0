    ...
    export default {
        ...
        data(){
            return{
                ...
                tableData:[],
                tableData1:[
                    {customer_name:"发发发",identity:1,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                    {customer_name:"发发发",identity:1,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                    {customer_name:"发发发",identity:1,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                    {customer_name:"发发发",identity:1,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                    {customer_name:"发发发",identity:1,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                ...
                tableData2:[
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:1},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:2},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:4},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:6},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:77},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:88},
                    {customer_name:"哈哈哈",identity:2,address:"个帅哥帅哥",account_owner:"发发发",account_num:"12121112",remark:"gsgsgsgsgsgsdg",id:99},
                ]
            }
        },
        mounted(){
        ...
        methods:{
            ...
            getCustomerLists(type){
                if(type===1){
                    ...
                    this.tableData = this.tableData2;//对接口，建议加一个type字段，判断房东还是租客
                }else {
                    this.tableData = '';
                }
            },
