          ...
          <el-form-item v-for="(item,index) in lordForm.slice(0,4)" :key="'lord1'+index" :prop="item.prop">
            <div class="form_item_container">
              ...
              <div class="item_content" style="width: 230px">
                <el-input  :placeholder="item.placeholder" v-model="form[item.prop]" :disabled="is_disabled" @focus="clickCallback(item.label)"></el-input>
              </div>
            </div>
          </el-form-item>
    ...
    export default {
      ...
      methods:{
        ...
        postLordEditData() {
          this.form.prices = [];
          this.form.pay_types = [];
          this.form.prices.push(this.form.prices_val);
          console.log(this.form);
          console.log(this.form.pay_types);
          this.form.pay_types.push(this.form.pay_types_val);

          if(this.row.id){
            this.$http.put(globalConfig.temporary_server + 'customer_collect/' + this.row.id, this.form).then(res => {
