          ...
          <el-col :span="8">
            <div class="">
              ...
              <el-form-item label="房屋地址">
                <HouseCommunity @getHouseIdName='getHouseIdName' :disabled="is_disabled" v-model="formParams.house_id"
                                width="200"></HouseCommunity>
              </el-form-item>
...
<script>
  export default {
    ...
    beforeMount() {
      ...
      if (this.formData.leader && this.formData.leader.length) {
        this.commonModuleData.leader_name = this.formData.leader && this.formData.leader.name;
      }
    ...
    mounted() {
      //是否可编辑
      this.is_disabled = this.checkOrEdit.is_check;
      //转换付款类型
